		...
		function Elements:AddResultsPanel(height)
			...
			return Panel
                ...
                function Elements:AddChatClient()
                    ...
                    -- ==============================================================
                    local function CreateMessage(sender, text, instant) -- DEĞİŞİKLİK 1: instant parametresi eklendi
                        ...
                        -- DEĞİŞİKLİK 1: instant kontrolü eklendi
                    ...
                    -- ==============================================================
                    local chatApi = {}
                    -- DEĞİŞİKLİK 2: instant parametresi eklendi ve CreateMessage'a iletildi
                    ...
                    -- DEĞİŞİKLİK 3: EditMessage'e instant eklendi
                    chatApi.EditMessage = function(msgFrame, newText, instant)
                        ...
                        -- DEĞİŞİKLİK 3: instant kontrolü eklendi
                        if not isUser and Config.TypewriterActive and not instant then
                            task.spawn(function()
                                task.wait(0.1)
                                for i = 1, #newText do
